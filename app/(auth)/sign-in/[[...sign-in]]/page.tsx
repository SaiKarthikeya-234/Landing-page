      ...
      <main className="relative overflow-hidden">
        <div className="relative mx-auto max-w-2xl pt-28 md:pt-36">
          <div className="pointer-events-none absolute inset-x-0 top-0 h-24 [mask-image:radial-gradient(50%_80%,white,transparent_85%)]">
            <SparklesCore id="signin-sparkles" background="transparent" particleDensity={280} className="h-full w-full" />
          </div>
          ...
          >
            <SignIn
              path="/sign-in"
              routing="path"
              // Remove afterSignInUrl so Clerk honors the return URL from middleware.
